                ...
                .toolbar {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        Button {
                            dismiss()
                            clickLocation = true
                            studyLocation = studyStore.setLocation(latitude: location.coordinate.latitude, longitude: location.coordinate.longitude, address: address)
                        } label: {
                            Text("완료")
                        }
                    }
...
struct StudyMapView_Previews: PreviewProvider {
    static var previews: some View {
        StudyMapView(studyStore: StudyStore(), region: .constant(MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: 37.5665, longitude: 126.9780), span: MKCoordinateSpan(latitudeDelta: 0.009, longitudeDelta: 0.009))), clickLocation: .constant(false), studyLocation: .constant(StudyLocation(latitude: 37.5665, longitude: 126.9780, address: "서울시청")))
    }
}
